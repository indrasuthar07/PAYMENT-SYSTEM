...
function Navbar() {
  ...
  return (
    <nav className="w-full bg-gradient-to-r from-blue-900 via-blue-700 to-purple-900/90 backdrop-blur-xl shadow-2xl border-b border-white/10 sticky top-0 z-50">
