...
function TransferModal({ showTransferModal, setShowTransferModal, reloadData }) {
    ...
    const handleVerifyAccount = async (accountId) => {
        ...
        setVerifying(true);
        try {
            const response = await axios.get(`https://payment-system-777.onrender.com/api/transactions/verify-account/${accountId}`, {
    ...
    const handleSubmit = async (values) => {
        ...
        try {
            const response = await axios.post(
                'https://payment-system-777.onrender.com/api/transactions/transfer',
                {
